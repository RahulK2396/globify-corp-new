...
const ShopifyDevelopment = () => {
  ...
  return (
    <>
      <SEOHead
        title="Shopify Development Agency UAE & India | Expert Shopify Partners | Globify"
        description="Top Shopify development agency in UAE & India. 300+ stores launched, 3x avg revenue growth. Custom Shopify, Shopify Plus, migration & CRO. Get a free Shopify growth plan."
        canonical="/shopify-development"
        faq={[
          { question: "Why choose Globify for Shopify development?", answer: "We're a certified Shopify Partner with 300+ stores launched, 3x average revenue growth, and deep expertise in Plus, headless, and custom apps — serving UAE and India markets." },
          { question: "How much does a Shopify store cost?", answer: "Basic stores start at $3K–$8K. Custom stores with advanced features range from $10K–$40K. Shopify Plus implementations start at $30K+." },
          { question: "Can you migrate my store to Shopify?", answer: "Yes. We handle migrations from WooCommerce, Magento, BigCommerce, and custom platforms, preserving SEO, customer data, and order history." },
          { question: "Do you provide ongoing Shopify support?", answer: "Absolutely. We offer monthly retainers for maintenance, optimization, new feature development, and growth strategy consulting." },
          { question: "How does AEO help Shopify stores rank in AI search?", answer: "We implement structured data, Speakable schema, and AI-optimized product content so AI search engines like ChatGPT cite your products when shoppers ask for recommendations." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              ...
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" />
