...
const ShopifyUAE = () => {
  ...
  return (
    <>
      <SEOHead
        title="Shopify Agency Dubai & UAE | Shopify Development UAE"
        description="Top Shopify agency in Dubai & UAE. Arabic RTL, COD, Tabby BNPL, VAT-compliant stores. 300+ stores, 3x avg revenue growth."
        canonical="/shopify-uae"
        faq={[
          { question: "Does Shopify support Arabic RTL for UAE stores?", answer: "Yes. We build fully bilingual Arabic/English Shopify stores with proper RTL layout, Arabic typography, and culturally localized UX for UAE and GCC markets." },
          { question: "Can you integrate Tabby, Tamara, and COD?", answer: "Absolutely. We integrate Tabby, Tamara (BNPL), Cash on Delivery, Apple Pay, and all regional payment methods UAE shoppers expect." },
          { question: "How much does Shopify development cost in the UAE?", answer: "Standard stores start at AED 20,000–AED 40,000. Custom Plus implementations range from AED 100,000–AED 250,000+." },
          { question: "Is Shopify VAT-compliant for UAE businesses?", answer: "Yes. We configure 5% UAE VAT, generate tax invoices, and integrate with FTA-compliant accounting systems." },
          { question: "Can you build a Shopify store for GCC expansion?", answer: "Yes. We build multi-market stores for UAE, Saudi Arabia, Kuwait, Bahrain, Oman, and Qatar with localized content and regional logistics." },
          { question: "How long does it take to launch a Shopify store in Dubai?", answer: "Standard stores launch in 3–5 weeks. Complex Shopify Plus builds take 8–14 weeks." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Development", url: "/shopify-development" },
          { name: "Shopify UAE", url: "/shopify-uae" },
        ]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Official Shopify Partner — Dubai
              </motion.div>
