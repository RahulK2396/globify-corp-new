  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "What business processes can be automated?", answer: "Data entry, invoice processing, order management, report generation, email workflows, HR onboarding, inventory updates, and almost any rule-based repetitive task." },
          { question: "What is the ROI of process automation?", answer: "Typically 300–500% ROI within the first year through labor cost savings, error reduction, and faster processing. Most clients see payback within 3–6 months." },
          { question: "Do I need to change my existing systems?", answer: "No. Our automation integrates with your existing tools via APIs, screen automation, and middleware, no system replacement required." },
          { question: "How is RPA different from AI automation?", answer: "RPA follows rules to automate structured tasks. AI automation adds intelligence, understanding unstructured data, making decisions, and learning from patterns." },
          { question: "How does AEO relate to process automation?", answer: "AEO ensures your automation expertise is cited by AI answer engines when businesses search for workflow automation, RPA, and intelligent process solutions." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
