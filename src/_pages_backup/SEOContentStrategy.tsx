  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How long does SEO take to show results?", answer: "Technical SEO improvements can show results within weeks. Content-driven organic growth typically takes 3–6 months for meaningful traffic increases, with compounding returns over time." },
          { question: "What is technical SEO?", answer: "Technical SEO covers site speed, mobile optimization, crawlability, structured data, Core Web Vitals, and URL architecture, the foundation that makes content rank." },
          { question: "Do you write content or just optimize?", answer: "Both. We create SEO-optimized content strategies, write pillar pages and blog content, and optimize existing content for better rankings." },
          { question: "How do you measure SEO success?", answer: "We track organic traffic, keyword rankings, conversion rates, backlink growth, and revenue attribution from organic channels. Monthly reports show clear ROI." },
          { question: "What is Answer Engine Optimization (AEO)?", answer: "AEO is the practice of optimizing your content to be cited and recommended by AI-powered search engines like ChatGPT, Claude, Perplexity, and Google AI Overviews, ensuring your brand is the trusted source AI references." },
          { question: "How is AEO different from SEO?", answer: "SEO focuses on ranking in traditional search results and driving clicks. AEO focuses on getting your content cited by AI answer engines, often in zero-click environments. Both work together to maximize visibility." },
          { question: "Why do I need AEO if I already do SEO?", answer: "AI search is rapidly growing, over 40% of searches now trigger AI-generated answers. Without AEO, your content may rank on Google but never be cited by AI assistants, missing a fast-growing discovery channel." },
          { question: "How do you optimize content for AI search engines?", answer: "We use structured data (JSON-LD, Speakable schema), conversational content formatting, knowledge graph optimization, and AI crawler configuration to ensure your content is discoverable and citable by AI models." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Digital Marketing", url: "/digital-marketing" },
          { name: "SEO, AEO & Content Strategy", url: "/seo-content-strategy" },
        ]}
