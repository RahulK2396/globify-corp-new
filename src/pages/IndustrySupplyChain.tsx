  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How does AI optimize supply chains?", answer: "AI enables predictive demand sensing, autonomous warehouse operations, intelligent route optimization, and real-time supply chain visibility, reducing costs by 40%." },
          { question: "How does AEO help logistics companies?", answer: "AEO ensures your supply chain expertise appears in AI-generated answers when businesses search for logistics optimization, warehouse automation, and demand forecasting solutions." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Industries", url: "/services" },
          { name: "Supply Chain", url: "/industries/supply-chain" },
        ]}
