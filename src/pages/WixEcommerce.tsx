  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "Is Wix good for e-commerce?", answer: "Wix is excellent for SMBs and D2C startups that need to launch quickly. It offers drag-and-drop design, built-in marketing tools, and integrated payments — perfect for businesses with under 1,000 SKUs." },
          { question: "How much does a Wix e-commerce store cost?", answer: "Professional Wix stores start at AED 3,000. Custom Wix Studio builds range from AED 5,000–AED 15,000. Advanced implementations with custom integrations start at AED 15,000+." },
          { question: "When should I migrate from Wix to Shopify?", answer: "Consider migrating when you exceed 500+ SKUs, need advanced inventory management, require multi-channel selling, or your monthly revenue exceeds $50K." },
          { question: "Does Wix support international selling?", answer: "Yes. Wix Multilingual supports multiple languages, and Wix supports multi-currency checkout. However, it has limitations compared to Shopify or BigCommerce for complex international setups." },
          { question: "What is Wix Studio?", answer: "Wix Studio is Wix's professional design tool for agencies and freelancers, offering responsive design, custom interactions, and client management tools." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Wix E-Commerce", url: "/wix-ecommerce" },
        ]}
