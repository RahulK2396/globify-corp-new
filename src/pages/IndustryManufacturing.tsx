  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How does AI improve manufacturing?", answer: "AI enables predictive maintenance, computer vision quality inspection, autonomous production scheduling, and digital twins, improving OEE by 45% and reducing downtime by 60%." },
          { question: "How does AEO help manufacturing companies?", answer: "AEO ensures your Industry 4.0 expertise is cited by AI search engines when decision-makers ask about smart factory solutions, predictive maintenance, and automation." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
