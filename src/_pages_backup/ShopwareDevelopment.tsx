  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "Why choose Shopware for German e-commerce?", answer: "Shopware is the leading e-commerce platform in the DACH region (Germany, Austria, Switzerland). It offers API-first architecture, native B2B features, and deep integration with German payment and logistics providers." },
          { question: "How much does Shopware development cost?", answer: "Shopware Community Edition stores start at €5,000 / AED 20,000. Professional Edition with B2B features ranges from €10,000–€30,000. Enterprise implementations start at €30,000+." },
          { question: "Is Shopware headless-ready?", answer: "Yes. Shopware 6 is built API-first with a full REST and Store API, making it ideal for headless commerce with React, Vue, or Next.js frontends." },
          { question: "Can you migrate from Magento to Shopware?", answer: "Yes. We handle full Magento-to-Shopware migrations preserving products, customers, orders, and SEO rankings." },
          { question: "Does Shopware support B2B commerce?", answer: "Yes. Shopware offers native B2B features including customer-specific pricing, quote management, role-based ordering, and company account hierarchies." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopware Development", url: "/shopware-development" },
        ]}
