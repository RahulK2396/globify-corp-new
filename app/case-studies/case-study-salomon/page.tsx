...
const CaseStudySalomon = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Salomon Case Study — GCC Shopify E-Commerce | Globify" description="How Globify built a localized GCC Shopify store for Salomon's regional distributor, replicating the global outdoor brand site with Arabic RTL and multi-country support." canonical="/case-study/salomon" />
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden bg-card flex items-center justify-center p-12">
              <Image src={clientSalomon} alt="Salomon brand" className="w-full max-w-[280px] object-contain" />
            </motion.div>
          </div>
        </div>
      </section>
