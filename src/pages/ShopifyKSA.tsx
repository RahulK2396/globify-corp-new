...
const ShopifyKSA = () => {
  ...
  return (
    <>
      <SEOHead
        title="Shopify Development Saudi Arabia | KSA E-Commerce"
        description="Certified Shopify agency for Saudi brands. ZATCA-compliant stores, Mada, STC Pay, Tamara BNPL & Arabic/English. 300+ stores launched."
        canonical="/shopify-ksa"
        faq={[
          { question: "Is Shopify compliant with ZATCA e-invoicing in Saudi Arabia?", answer: "Yes. We implement ZATCA Phase 2 e-invoicing integration, QR code generation on invoices, and full VAT 15% compliance for all Shopify stores in KSA." },
          { question: "Can you integrate Mada and STC Pay with Shopify?", answer: "Absolutely. We integrate Mada debit cards, STC Pay, Apple Pay, Tamara BNPL, and all major Saudi payment methods for maximum conversion." },
          { question: "How much does Shopify development cost in Saudi Arabia?", answer: "Starter stores begin at SAR 3,000. Growth packages at SAR 12,000. Enterprise Shopify Plus implementations from SAR 30,000+." },
          { question: "Do you build Arabic RTL Shopify stores?", answer: "Yes. We build fully bilingual Arabic/English stores with proper RTL layout, Arabic typography, and localized checkout experiences." },
          { question: "Can you integrate Saudi shipping carriers with Shopify?", answer: "Yes. We integrate SMSA Express, Aramex, Naqel, and J&T Express with automated tracking and cash-on-delivery support." },
          { question: "How long does it take to launch a Shopify store in KSA?", answer: "Standard stores launch in 3–5 weeks. Complex Shopify Plus builds with ERP and ZATCA integration take 8–12 weeks." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Development", url: "/shopify-development" },
          { name: "Shopify Saudi Arabia", url: "/shopify-ksa" },
        ]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> شريك Shopify معتمد
              </motion.div>
