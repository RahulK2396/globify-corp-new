  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        services={[
          { name: "Digital Strategy Consulting", description: "AI-first transformation roadmaps and digital maturity audits.", url: "/digital-transformation" },
          { name: "Cloud Migration", description: "Seamless migration to AWS, Azure, or Google Cloud.", url: "/digital-transformation" },
          { name: "Process Automation", description: "Automate workflows with RPA and intelligent automation.", url: "/process-automation" },
          { name: "AI Integration", description: "Embed AI into existing systems for intelligent decision-making.", url: "/ai-automation" },
        ]}
        howTo={{
          name: "How to Execute a Digital Transformation",
          steps: [
            { name: "Digital Maturity Audit", text: "Assess current technology landscape, processes, and readiness." },
            { name: "Strategy & Roadmap", text: "Define transformation vision, priorities, and phased execution plan." },
            { name: "Implementation", text: "Execute in agile sprints — automation, cloud, AI, and integration." },
            { name: "Optimization & Innovation", text: "Continuous monitoring, optimization, and scaling of digital capabilities." },
          ],
        }}
