      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-hero/90 backdrop-blur-md border-b border-hero-foreground/10">
        <div className="container mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            >
              <Image src={whatsappIcon} alt="WhatsApp" width={36} height={36} className="w-full h-full object-cover" />
            </a>
            <button
          ...
          {/* Mobile Toggle */}
          <button onClick={() => setIsOpen(!isOpen)} className="lg:hidden text-hero-foreground">
              ...
              <div className="w-[calc(100%-3rem)] max-w-[1440px] h-[360px] bg-background rounded-2xl shadow-2xl shadow-foreground/10 border border-border/20 px-12 py-10 overflow-hidden">
                {activeMega === "services" && (
                  <div className="flex gap-10 h-full">
                    <Link href="/services" className="group flex-shrink-0 w-[280px] rounded-[20px] relative overflow-hidden flex flex-col justify-end">
                      <Image src={megaMenuServices} alt="" fill className="object-cover" />
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-x-12">
                      ...
                      <div>
                        ...
                        <Link href="/hire-developers" className="mt-4 inline-flex items-center gap-2 bg-foreground text-background px-4 py-2 rounded-md text-sm font-semibold hover:bg-foreground/90 transition-colors">
                ...
                {activeMega === "industries" && (
                  <div className="flex gap-10 h-full">
                    <Link href="/industries/healthcare" className="group flex-shrink-0 w-[280px] rounded-[20px] relative overflow-hidden flex flex-col justify-end">
                      <Image src={megaMenuIndustries} alt="" fill className="object-cover" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                      <div className="relative z-10 p-7 pt-32">
                ...
                {activeMega === "products" && (
                  <div className="flex gap-10 h-full">
                    <Link href="/products" className="group flex-shrink-0 w-[280px] rounded-[20px] relative overflow-hidden flex flex-col justify-end">
                      <Image src={megaMenuProducts} alt="" fill className="object-cover" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                      <div className="relative z-10 p-7 pt-32">
        ...
        {isOpen && (
          ...
          >
            <div className="p-6 pt-24 space-y-1">
              <Link href="/" onClick={() => setIsOpen(false)} className="block py-3.5 text-[15px] font-medium text-hero-foreground/80 hover:text-primary border-b border-hero-foreground/[0.06]">Home</Link>
              <Link href="/about" onClick={() => setIsOpen(false)} className="block py-3.5 text-[15px] font-medium text-hero-foreground/80 hover:text-primary border-b border-hero-foreground/[0.06]">About Us</Link>
              ...
              <Link href="/projects" onClick={() => setIsOpen(false)} className="block py-3.5 text-[15px] font-medium text-hero-foreground/80 hover:text-primary border-b border-hero-foreground/[0.06]">Our Projects</Link>
              <Link href="/resources" onClick={() => setIsOpen(false)} className="block py-3.5 text-[15px] font-medium text-hero-foreground/80 hover:text-primary border-b border-hero-foreground/[0.06]">Resources</Link>
              <Link href="/blog" onClick={() => setIsOpen(false)} className="block py-3.5 text-[15px] font-medium text-hero-foreground/80 hover:text-primary border-b border-hero-foreground/[0.06]">Blog</Link>
              <div className="pt-8 pb-10 space-y-3">
                <button
                  onClick={() => { setIsOpen(false); openContactDialog(); }}
