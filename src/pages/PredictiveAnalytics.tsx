  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "What data do I need for predictive analytics?", answer: "Sales history, customer behavior, inventory records, and marketing data. We start with whatever data you have and build from there." },
          { question: "How accurate are predictive models?", answer: "Our models achieve 85–95% accuracy depending on data quality and use case. Accuracy improves over time as models learn from new data." },
          { question: "How long does it take to deploy a predictive model?", answer: "Data audit and model development takes 4–8 weeks. Production deployment with dashboards adds another 2–4 weeks." },
          { question: "What business outcomes can predictive analytics drive?", answer: "Demand forecasting, churn prediction, price optimization, marketing attribution, fraud detection, and supply chain optimization." },
          { question: "How does AEO leverage predictive analytics?", answer: "Predictive analytics identifies which content topics and queries are trending in AI search, allowing you to create AEO-optimized content that AI engines will cite before competitors." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
