  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={faq}
        services={[
          { name: "AI-Powered A/B Testing", description: "AI-accelerated experimentation that finds winning variations 3x faster", url: "/cro-revenue-engineering" },
          { name: "Predictive Personalization", description: "Dynamic content and offers based on real-time user behavior and AI scoring", url: "/cro-revenue-engineering" },
          { name: "Revenue Attribution Intelligence", description: "AI multi-touch attribution revealing exactly what drives revenue", url: "/cro-revenue-engineering" },
        ]}
