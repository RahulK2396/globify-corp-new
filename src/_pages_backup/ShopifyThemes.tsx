...
const ShopifyThemes = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Custom Shopify Themes, Conversion-Focused Design | Globify"
        description="Bespoke Shopify storefronts designed to captivate your audience, boost conversions, and deliver a seamless brand experience across all devices. UAE & India."
        canonical="/shopify-themes"
        faq={[
          { question: "How much does a custom Shopify theme cost?", answer: "Custom themes range from $5K–$15K for standard designs to $15K–$40K for premium, fully bespoke storefronts with advanced animations and features." },
          { question: "How long does a custom theme take to build?", answer: "4–6 weeks for standard themes, 6–10 weeks for premium designs with extensive customization and A/B testing integration." },
          { question: "Can I update the theme myself after launch?", answer: "Yes. We build with Shopify 2.0 sections so you can customize layouts, add content, and update images through the Shopify editor — no coding needed." },
          { question: "How does AEO apply to Shopify stores?", answer: "AEO ensures your product pages and content are structured with schema markup so AI search engines like ChatGPT and Google AI Overviews cite your store as a trusted source." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Themes", url: "/shopify-themes" },
        ]}
