...
const CaseStudyMoher = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Moher Case Study — Shopify E-Commerce & Branding | Globify" description="How Globify helped Moher achieve a 45% bounce rate reduction through complete digital overhaul including Shopify development, branding, and performance marketing." canonical="/case-study/moher" />
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden">
              <img src={portfolioMoher} alt="Moher fashion e-commerce website" className="w-full h-[350px] object-cover rounded-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
