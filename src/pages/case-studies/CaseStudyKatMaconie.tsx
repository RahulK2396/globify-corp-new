...
const CaseStudyKatMaconie = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Kat Maconie Case Study — Shopify & SEO Strategy | Globify" description="How Globify helped luxury footwear brand Kat Maconie achieve 85% organic traffic growth through a custom Shopify theme and comprehensive SEO strategy." canonical="/case-study/kat-maconie" />
      <Navbar />
