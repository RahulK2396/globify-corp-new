...
const ShopifyGermany = () => {
  ...
  return (
    <>
      <SEOHead
        title="Shopify Agentur Deutschland | Shopify Development Germany"
        description="Certified Shopify agency for German brands. GDPR-compliant stores, Klarna, Trusted Shops & multi-currency. 300+ stores launched."
        canonical="/shopify-germany"
        faq={[
          { question: "Is Shopify GDPR-compliant for German stores?", answer: "Yes. Shopify provides GDPR-compliant data handling, cookie consent, and privacy tools. We implement Trusted Shops integration, Impressum, and Datenschutz pages for full German legal compliance." },
          { question: "Can you integrate Klarna and German payment methods?", answer: "Absolutely. We integrate Klarna, SOFORT, Giropay, PayPal, and all major German payment methods including invoice payment (Kauf auf Rechnung)." },
          { question: "How much does Shopify development cost in Germany?", answer: "Standard Shopify stores start at €5,000–€10,000. Custom Plus implementations range from €25,000–€60,000+. We provide detailed quotes after a free consultation." },
          { question: "Do you support Trusted Shops certification?", answer: "Yes. We handle full Trusted Shops integration including buyer protection badge, review collection, and legal text generation for German compliance." },
          { question: "Can you build a multilingual Shopify store for DACH markets?", answer: "Yes. We build stores supporting German, Austrian German, and Swiss German with localized content, currencies (EUR/CHF), and regional shipping rules." },
          { question: "How long does it take to launch a Shopify store in Germany?", answer: "Standard stores launch in 4–6 weeks. Complex Shopify Plus builds with ERP integration take 8–14 weeks. We prioritize GDPR compliance from day one." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Development", url: "/shopify-development" },
          { name: "Shopify Germany", url: "/shopify-germany" },
        ]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Zertifizierter Shopify Partner
              </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <motion.div key={s.title} variants={fadeUp} className="bg-background border border-border rounded-xl p-6 hover:border-primary/30 hover:shadow-lg transition-all group">
                ...
                {s.link && (
                  <Link to={s.link} className="text-xs font-semibold text-primary flex items-center gap-1 group-hover:gap-2 transition-all">
