          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" required placeholder="John Doe" className="bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground placeholder:text-hero-foreground/30" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email" className="text-hero-foreground/70 text-sm">Email *</Label>
                <Input id="email" type="email" required placeholder="john@company.com" className="bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground placeholder:text-hero-foreground/30" />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-hero-foreground/70 text-sm">Phone</Label>
                <Input id="phone" placeholder="+971 50 000 0000" className="bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground placeholder:text-hero-foreground/30" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="company" className="text-hero-foreground/70 text-sm">Company</Label>
                <Input id="company" placeholder="Company Name" className="bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground placeholder:text-hero-foreground/30" />
              </div>
            </div>
            <div className="space-y-2">
              <Label htmlFor="service" className="text-hero-foreground/70 text-sm">Service Interested In</Label>
              <select id="service" className="w-full h-10 rounded-md border bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground px-3 text-sm">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="message" required rows={3} placeholder="Tell us about your project..." className="bg-hero-foreground/5 border-hero-foreground/10 text-hero-foreground placeholder:text-hero-foreground/30 resize-none" />
            </div>
