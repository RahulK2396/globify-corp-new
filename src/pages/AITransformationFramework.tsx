  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={faq}
        services={[
          { name: "Digital Maturity Audit", description: "Comprehensive assessment of technology landscape and AI readiness", url: "/ai-transformation-framework" },
          { name: "AI Transformation Roadmap", description: "ROI-driven transformation strategy aligned with business KPIs", url: "/ai-transformation-framework" },
          { name: "AI Implementation & Integration", description: "End-to-end deployment of AI-powered business systems", url: "/ai-transformation-framework" },
        ]}
