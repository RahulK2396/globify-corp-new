  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "What is a good ROAS for paid advertising?", answer: "A healthy ROAS varies by industry, typically 3–5x for e-commerce and 5–10x for SaaS. We optimize campaigns to exceed industry benchmarks." },
          { question: "How much budget do I need for PPC?", answer: "We recommend a minimum of $2K/month for Google Ads and $1.5K/month for social ads. Budget scales based on your market, competition, and growth goals." },
          { question: "How do you optimize ad campaigns?", answer: "Through continuous A/B testing of creatives, audiences, and landing pages. We use AI-powered bidding strategies and weekly optimization cycles." },
          { question: "Which advertising platform is best for my business?", answer: "Google Ads for intent-driven searches, Meta for D2C and awareness, LinkedIn for B2B lead gen. We often recommend a multi-platform approach." },
          { question: "How do PPC and AEO work together?", answer: "PPC drives immediate traffic while AEO builds long-term visibility in AI search engines. Combined, they ensure your brand appears in both paid results and AI-generated answers." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
