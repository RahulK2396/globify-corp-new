  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "Which social media platforms should my business be on?", answer: "It depends on your audience. B2C brands thrive on Instagram and TikTok. B2B companies need LinkedIn. We analyze your audience and competitors to recommend the right mix." },
          { question: "How often should we post on social media?", answer: "Consistency matters more than frequency. We typically recommend 3–5 posts per week per platform, with a mix of content types optimized for each algorithm." },
          { question: "Do you create social media content?", answer: "Yes. We handle strategy, content creation, graphic design, video editing, community management, and paid social campaigns — end to end." },
          { question: "How do you measure social media ROI?", answer: "We track engagement rates, follower growth, website traffic, lead generation, and revenue attribution from social channels. Monthly reports connect social activity to business outcomes." },
          { question: "How does AEO enhance social media strategy?", answer: "AEO-optimized social content gets cited by AI assistants when users ask about brands, products, or industry topics, extending your social reach beyond traditional platforms into AI search." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Digital Marketing", url: "/digital-marketing" },
          { name: "Social Media & Branding", url: "/social-media-brand" },
        ]}
