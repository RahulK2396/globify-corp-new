...
const ShopifySouthAfrica = () => {
  ...
  return (
    <>
      <SEOHead title="Shopify Development South Africa | SA E-Commerce" description="Certified Shopify agency for South African brands. PayFast, SnapScan, Ozow EFT, POPIA-compliant. 300+ stores launched." canonical="/shopify-south-africa"
        faq={[
          { question: "Can you integrate PayFast and Ozow with Shopify?", answer: "Yes. PayFast, SnapScan, Ozow EFT, and all South African payment methods fully integrated." },
          { question: "How much does Shopify cost in South Africa?", answer: "Starter from ZAR 15,000. Growth at ZAR 55,000. Enterprise from ZAR 140,000+." },
          { question: "Is Shopify POPIA-compliant?", answer: "Yes. We implement full POPIA data protection compliance for South African e-commerce stores." },
          { question: "Which shipping carriers for South Africa?", answer: "The Courier Guy, Pargo pickup points, and major SA logistics providers." },
          { question: "Do you support ZAR currency?", answer: "Yes. Full ZAR pricing with multi-currency for cross-border African trade." },
          { question: "How long to launch?", answer: "4–6 weeks standard, 8–14 weeks for complex enterprise builds." },
        ]}
        breadcrumbs={[{ name: "Home", url: "/" }, { name: "E-Commerce", url: "/ecommerce" }, { name: "Shopify Development", url: "/shopify-development" }, { name: "Shopify South Africa", url: "/shopify-south-africa" }]}
