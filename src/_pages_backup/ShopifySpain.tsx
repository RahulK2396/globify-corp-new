...
const ShopifySpain = () => {
  ...
  return (
    <>
      <SEOHead title="Shopify España | Desarrollo Shopify Spain" description="Certified Shopify agency for Spanish brands. Bizum, Redsys, GDPR/LOPD-compliant stores. Correos & SEUR integration. 300+ stores." canonical="/shopify-spain"
        faq={[
          { question: "Can you integrate Bizum and Redsys with Shopify?", answer: "Yes. Bizum, Redsys, Stripe, Sequra BNPL, and all Spanish payment methods fully integrated." },
          { question: "How much does Shopify development cost in Spain?", answer: "Starter from €750. Growth at €2,900. Enterprise from €7,500+." },
          { question: "Is Shopify GDPR/LOPD-compliant in Spain?", answer: "Yes. Full GDPR and LOPD compliance with cookie consent, privacy policies, and AEAT tax reporting." },
          { question: "Which shipping carriers for Spain?", answer: "Correos, SEUR, MRW, and GLS with automated tracking and returns." },
          { question: "Do you build Spanish-language stores?", answer: "Yes. Full Spanish/English bilingual stores with localized checkout." },
          { question: "How long to launch?", answer: "4–6 weeks standard, 8–14 weeks enterprise." },
        ]}
        breadcrumbs={[{ name: "Home", url: "/" }, { name: "E-Commerce", url: "/ecommerce" }, { name: "Shopify Development", url: "/shopify-development" }, { name: "Shopify Spain", url: "/shopify-spain" }]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <Image src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Partner Certificado de Shopify
              </motion.div>
