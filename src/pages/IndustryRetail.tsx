  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How does AI improve retail conversions?", answer: "AI powers predictive personalization, dynamic pricing, smart product recommendations, and autonomous inventory management, lifting conversions by 3.2x on average." },
          { question: "How does AEO help retail brands?", answer: "AEO ensures your products and retail expertise are cited by AI shopping assistants and answer engines when consumers search for product recommendations and solutions." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
