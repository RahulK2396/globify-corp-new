...
const CaseStudyInstaRunway = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="InstaRunway Case Study — GCC Shopify Fashion Store | Globify" description="How Globify built a localized GCC Shopify store for InstaRunway's luxury fashion marketplace with Arabic RTL, multi-country support, and custom theme design." canonical="/case-study/instarunway" />
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden">
              <img src={portfolioInstaRunway} alt="InstaRunway GCC fashion e-commerce" className="w-full h-[350px] object-cover rounded-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
