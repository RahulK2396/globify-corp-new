  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        services={[
          { name: "Web Development", description: "Custom websites, CMS, PWAs, and web applications optimized for performance and conversion.", url: "/web-development" },
          { name: "App Development", description: "Native and cross-platform mobile apps for iOS and Android with scalable architecture.", url: "/app-development" },
          { name: "E-Commerce Solutions", description: "Shopify, WooCommerce, and custom e-commerce platforms with payment integration.", url: "/ecommerce" },
          { name: "Digital Marketing", description: "SEO, PPC, social media marketing, and conversion rate optimization strategies.", url: "/digital-marketing" },
          { name: "AI & Automation", description: "AI chatbots, workflow automation, and predictive analytics for business efficiency.", url: "/ai-automation" },
          { name: "ERP Solutions", description: "Custom ERP systems for inventory, finance, HR, and manufacturing operations.", url: "/erp-solutions" },
        ]}
      />
      <Navbar />
