...
const ShopifyFrance = () => {
  ...
  return (
    <>
      <SEOHead
        title="Agence Shopify France | Shopify Development France"
        description="Expert Shopify agency for French brands. Carte Bancaire, Colissimo, RGPD-compliant stores. 300+ stores, 3x avg revenue growth."
        canonical="/shopify-france"
        faq={[
          { question: "Is Shopify suitable for the French market?", answer: "Yes. Shopify supports Carte Bancaire, French VAT, Colissimo shipping, and RGPD (GDPR) compliance — making it ideal for French e-commerce." },
          { question: "Can you integrate Carte Bancaire and French payment methods?", answer: "Absolutely. We integrate CB, PayPal, Alma (BNPL), Apple Pay, and all payment methods French shoppers expect." },
          { question: "How much does Shopify development cost in France?", answer: "Standard Shopify stores start at €5,000–€10,000. Custom Plus implementations range from €25,000–€60,000+." },
          { question: "Do you handle French legal compliance (CGV, mentions légales)?", answer: "Yes. We create CGV (Conditions Générales de Vente), mentions légales, politique de confidentialité, and droit de rétractation pages." },
          { question: "Can you build a multilingual store for French-speaking markets?", answer: "Yes. We build stores supporting France, Belgium, Switzerland, Luxembourg, and French-speaking Africa with localized content." },
          { question: "How long does it take to launch a Shopify store in France?", answer: "Standard stores launch in 4–6 weeks. Shopify Plus builds with ERP and marketplace integration take 8–14 weeks." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Development", url: "/shopify-development" },
          { name: "Shopify France", url: "/shopify-france" },
        ]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Partenaire Shopify Certifié
              </motion.div>
