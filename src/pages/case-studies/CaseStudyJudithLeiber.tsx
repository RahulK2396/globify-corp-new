...
const CaseStudyJudithLeiber = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="Judith Leiber Case Study — GCC Shopify Store | Globify" description="How Globify built a localized GCC Shopify store for Judith Leiber's regional distributor, replicating the global luxury brand experience with Arabic RTL and multi-country support." canonical="/case-study/judith-leiber" />
      <Navbar />
