  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "How long does an e-commerce migration take?", answer: "Simple migrations (Wix to Shopify) take 2–4 weeks. Complex migrations (Magento 1 to Shopify Plus or headless) take 6–12 weeks depending on catalog size and custom features." },
          { question: "Will I lose my SEO rankings during migration?", answer: "No. We implement comprehensive 301 redirect maps, preserve URL structures where possible, migrate all meta data, and monitor rankings post-migration to ensure zero SEO loss." },
          { question: "How much does e-commerce migration cost?", answer: "Simple migrations start at AED 5,000. Mid-complexity migrations: AED 10,000–25,000. Enterprise migrations with custom integrations: AED 25,000+." },
          { question: "Can you migrate customer data and order history?", answer: "Yes. We migrate all products, customers, order history, reviews, and content. Customer passwords may require a reset depending on the source platform." },
          { question: "What platforms do you migrate from?", answer: "We migrate from Wix, Squarespace, WooCommerce, Magento 1/2, PrestaShop, BigCartel, Ecwid, and custom-built platforms to any modern e-commerce solution." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
