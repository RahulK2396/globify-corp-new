  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "Why choose BigCommerce over Shopify?", answer: "BigCommerce charges zero transaction fees regardless of payment gateway, offers more built-in features without apps, supports multi-storefront from a single dashboard, and provides a dedicated B2B Edition." },
          { question: "How much does BigCommerce development cost?", answer: "Basic BigCommerce stores start at AED 8,000. Custom stores with advanced features range from AED 15,000–AED 40,000. Enterprise implementations start at AED 40,000+." },
          { question: "Does BigCommerce support headless commerce?", answer: "Yes. BigCommerce has robust headless capabilities with its Channels API, supporting Next.js, Gatsby, and other modern frameworks." },
          { question: "Can you migrate from Shopify to BigCommerce?", answer: "Yes. We handle full migrations preserving products, customers, orders, and SEO rankings with zero downtime." },
          { question: "Does BigCommerce support B2B?", answer: "Yes. BigCommerce B2B Edition includes customer-specific pricing, purchase orders, quote management, and company account hierarchies." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "BigCommerce Development", url: "/bigcommerce-development" },
        ]}
