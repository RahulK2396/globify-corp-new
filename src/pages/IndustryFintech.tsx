  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How is AI used in fintech?", answer: "AI powers real-time fraud detection, automated compliance monitoring, predictive credit scoring, and algorithmic trading, reducing costs by 70% while improving accuracy." },
          { question: "How does AEO benefit fintech companies?", answer: "AEO ensures your fintech expertise is cited by AI search engines like ChatGPT and Perplexity when users ask about payment solutions, compliance, or financial technology." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
