...
const Ecommerce = () => (
  <div className="min-h-screen">
    <SEOHead
      ...
      services={[
        { name: "Shopify Development", description: "Custom Shopify stores optimized for conversion and growth.", url: "/shopify-development" },
        { name: "Marketplace Integration", description: "Multi-channel selling on Amazon, Noon, and Trendyol.", url: "/ecommerce" },
        { name: "E-Commerce ERP", description: "Unified inventory, order, and fulfillment management.", url: "/erp-solutions" },
        { name: "Conversion Optimization", description: "Data-driven CRO to maximize revenue per visitor.", url: "/cro-revenue-engineering" },
      ]}
