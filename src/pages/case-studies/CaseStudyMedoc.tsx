...
const CaseStudyMedoc = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="MEDOC HMS Case Study — Hospital Management System | Globify" description="MEDOC HMS: All-in-one clinic management software trusted by 2,000+ clinics and 8,000+ doctors. EMR, appointments, billing, lab, pharmacy, and real-time analytics." canonical="/case-study/medoc-hms" />
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden">
              <img src={portfolioMedoc} alt="MEDOC HMS clinic management dashboard" className="w-full h-[350px] object-cover rounded-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
