...
const ShopifyOman = () => {
  ...
  return (
    <>
      <SEOHead title="Shopify Development Oman | Oman E-Commerce" description="Certified Shopify agency for Omani brands. OmanNet, Thawani payments, Arabic/English stores. CPA-compliant e-commerce." canonical="/shopify-oman"
        faq={[
          { question: "Can you integrate Thawani and OmanNet with Shopify?", answer: "Yes. OmanNet, Thawani Pay, Apple Pay, and all Omani payment methods fully integrated." },
          { question: "How much does Shopify cost in Oman?", answer: "Starter from OMR 300. Growth at OMR 1,200. Enterprise from OMR 3,000+." },
          { question: "Is Shopify CPA-compliant in Oman?", answer: "Yes. Full Consumer Protection Authority compliance for Omani e-commerce." },
          { question: "Do you build Arabic stores?", answer: "Yes. Full Arabic/English bilingual with RTL layout." },
          { question: "Which shipping carriers for Oman?", answer: "Oman Post, Aramex, and local couriers with COD support." },
          { question: "How long to launch?", answer: "3–5 weeks standard, 8–12 weeks complex." },
        ]}
        breadcrumbs={[{ name: "Home", url: "/" }, { name: "E-Commerce", url: "/ecommerce" }, { name: "Shopify Development", url: "/shopify-development" }, { name: "Shopify Oman", url: "/shopify-oman" }]}
