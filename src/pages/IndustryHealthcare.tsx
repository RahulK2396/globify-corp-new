  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How is AI transforming healthcare?", answer: "AI powers predictive diagnostics, automated clinical documentation, intelligent triage, and autonomous hospital operations, reducing admin costs by 60% while improving patient outcomes." },
          { question: "How does AEO help healthcare brands?", answer: "Answer Engine Optimization ensures your healthcare content is cited by AI assistants like ChatGPT and Google AI Overviews when patients and professionals search for medical solutions." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
