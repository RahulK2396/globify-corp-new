  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "Why choose PrestaShop for European e-commerce?", answer: "PrestaShop is built for European markets with native GDPR compliance, multi-language, multi-currency, and EU tax rules built in. It powers 300,000+ stores, primarily in France, Spain, and Italy." },
          { question: "How much does PrestaShop development cost?", answer: "Basic PrestaShop stores start at €2,500 / AED 10,000. Custom multi-language stores range from €5,000–€15,000. Enterprise implementations with ERP integration start at €15,000+." },
          { question: "Can you migrate from WooCommerce or Magento to PrestaShop?", answer: "Yes. We handle full migrations preserving products, customers, orders, SEO rankings, and content with zero downtime." },
          { question: "Is PrestaShop GDPR compliant?", answer: "Yes. PrestaShop has native GDPR features including consent management, data export, right to erasure, and cookie compliance — all built into the core platform." },
          { question: "Does PrestaShop support multi-language stores?", answer: "Yes. PrestaShop supports unlimited languages natively with full product, CMS, and checkout translation capabilities — ideal for cross-border European selling." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "PrestaShop Development", url: "/prestashop-development" },
        ]}
