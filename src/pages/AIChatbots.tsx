  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        faq={[
          { question: "How much does an AI chatbot cost?", answer: "Custom AI chatbots range from $5K for basic FAQ bots to $50K+ for enterprise conversational AI with NLP, integrations, and multilingual support." },
          { question: "Can chatbots handle complex customer queries?", answer: "Yes. Modern AI chatbots use large language models to understand context, handle multi-turn conversations, and escalate to humans when needed." },
          { question: "Which platforms do your chatbots support?", answer: "We deploy chatbots on WhatsApp, websites, Facebook Messenger, Slack, Microsoft Teams, and custom mobile apps, all from one platform." },
          { question: "How long does it take to build an AI chatbot?", answer: "Basic chatbots launch in 2–4 weeks. Enterprise conversational AI systems take 6–12 weeks including training, testing, and integration." },
          { question: "How does AEO work with AI chatbots?", answer: "AEO-optimized content feeds your chatbot's knowledge base, ensuring it provides accurate, authoritative answers, and your brand gets cited when AI search engines reference chatbot solutions." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
