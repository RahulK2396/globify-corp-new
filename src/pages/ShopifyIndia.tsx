...
const ShopifyIndia = () => {
  ...
  return (
    <>
      <SEOHead
        title="Shopify Development India | Shopify Agency India"
        description="Leading Shopify agency in India. UPI, COD, GST-compliant D2C stores. 300+ stores launched, 3x avg revenue growth. Free audit."
        canonical="/shopify-india"
        faq={[
          { question: "Is Shopify a good platform for Indian D2C brands?", answer: "Yes. Shopify supports UPI, COD, GST invoicing, and Razorpay — making it ideal for India's fast-growing D2C market worth $100B+ by 2026." },
          { question: "Can you integrate UPI, Razorpay, and COD?", answer: "Absolutely. We integrate UPI, Razorpay, PhonePe, Paytm, COD with verification, and all payment methods Indian shoppers use." },
          { question: "How much does Shopify development cost in India?", answer: "Standard stores start at ₹3–5 lakh. Custom Plus implementations range from ₹15–40 lakh. We provide detailed quotes after a free consultation." },
          { question: "Is Shopify GST-compliant for Indian businesses?", answer: "Yes. We configure GST rates (CGST, SGST, IGST), generate GST-compliant invoices, and integrate with Tally and Zoho Books." },
          { question: "Can you help with D2C brand building on Shopify?", answer: "Yes. We've launched 100+ D2C brands in India with complete brand strategy, store development, and growth marketing." },
          { question: "How long does it take to launch a Shopify store in India?", answer: "Standard stores launch in 2–4 weeks. Complex Shopify Plus builds take 6–12 weeks." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify Development", url: "/shopify-development" },
          { name: "Shopify India", url: "/shopify-india" },
        ]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <img src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Official Shopify Partner — India
              </motion.div>
