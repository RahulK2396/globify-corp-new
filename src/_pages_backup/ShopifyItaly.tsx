...
const ShopifyItaly = () => {
  ...
  return (
    <>
      <SEOHead title="Shopify Italia | Sviluppo Shopify Italy" description="Certified Shopify agency for Italian brands. Bancomat Pay, Satispay, Scalapay BNPL, GDPR-compliant. Poste Italiane integration." canonical="/shopify-italy"
        faq={[
          { question: "Can you integrate Bancomat Pay and Satispay with Shopify?", answer: "Yes. Bancomat Pay, Satispay, Scalapay BNPL, and all Italian payment methods fully integrated." },
          { question: "How much does Shopify development cost in Italy?", answer: "Starter from €750. Growth at €2,900. Enterprise from €7,500+." },
          { question: "Is Shopify GDPR-compliant for Italian stores?", answer: "Yes. Full GDPR and Codice del Consumo compliance with Garante Privacy guidelines." },
          { question: "Which shipping carriers for Italy?", answer: "Poste Italiane, BRT, GLS, and SDA with automated tracking." },
          { question: "Do you build Italian-language stores?", answer: "Yes. Full Italian/English bilingual stores." },
          { question: "How long to launch?", answer: "4–6 weeks standard, 8–14 weeks enterprise." },
        ]}
        breadcrumbs={[{ name: "Home", url: "/" }, { name: "E-Commerce", url: "/ecommerce" }, { name: "Shopify Development", url: "/shopify-development" }, { name: "Shopify Italy", url: "/shopify-italy" }]}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-6">
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border/20 rounded-full px-4 py-1.5 text-xs font-medium text-foreground shadow-sm">
                <Image src={shopifyLogo} alt="Shopify Partner" className="h-4 w-auto" /> Partner Certificato Shopify
              </motion.div>
