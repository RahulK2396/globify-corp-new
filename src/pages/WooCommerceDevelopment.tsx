  ...
  return (
    <>
      <SEOHead
        ...
        faq={[
          { question: "Why choose WooCommerce for my online store?", answer: "WooCommerce offers unlimited customization, full ownership of your data, powerful SEO built on WordPress, and no monthly platform fees — making it ideal for content-rich, SEO-driven e-commerce businesses." },
          { question: "How much does a WooCommerce store cost?", answer: "Basic stores start at AED 2,500. Custom stores with advanced features range from AED 10,000–25,000. Enterprise implementations with headless architecture start at AED 25,000+." },
          { question: "Can you migrate my store to WooCommerce?", answer: "Yes. We handle migrations from Shopify, Magento, BigCommerce, and custom platforms, preserving SEO, customer data, and order history." },
          { question: "Do you provide ongoing WooCommerce support?", answer: "Absolutely. We offer monthly retainers for maintenance, security updates, plugin management, and growth strategy consulting." },
          { question: "How does AEO improve WooCommerce visibility?", answer: "We optimize your WooCommerce store with structured data, FAQ schema, and AI-friendly content so your products are cited by AI assistants like ChatGPT and Google AI Overviews." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "WooCommerce Development", url: "/woocommerce-development" },
        ]}
