...
const ShopifyBahrain = () => {
  ...
  return (
    <>
      <SEOHead title="Shopify Development Bahrain | Bahrain E-Commerce" description="Certified Shopify agency for Bahraini brands. BenefitPay, Tap, Arabic/English stores. CBB-compliant e-commerce solutions." canonical="/shopify-bahrain"
        faq={[
          { question: "Can you integrate BenefitPay with Shopify?", answer: "Yes. We integrate BenefitPay, Tap Payments, Apple Pay, and all Bahraini payment methods." },
          { question: "How much does Shopify cost in Bahrain?", answer: "Starter from BHD 300. Growth at BHD 1,200. Enterprise from BHD 3,000+." },
          { question: "Is Shopify CBB-compliant in Bahrain?", answer: "Yes. We ensure compliance with Central Bank of Bahrain regulations for e-commerce." },
          { question: "Do you build Arabic RTL stores?", answer: "Yes. Full Arabic/English bilingual stores with RTL layout." },
          { question: "Which shipping carriers for Bahrain?", answer: "Aramex, DHL, and local Bahraini couriers with COD support." },
          { question: "How long to launch?", answer: "3–5 weeks standard, 8–12 weeks complex." },
        ]}
        breadcrumbs={[{ name: "Home", url: "/" }, { name: "E-Commerce", url: "/ecommerce" }, { name: "Shopify Development", url: "/shopify-development" }, { name: "Shopify Bahrain", url: "/shopify-bahrain" }]}
