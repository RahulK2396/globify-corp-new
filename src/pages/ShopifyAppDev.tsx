...
const ShopifyAppDev = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Shopify App Development, Custom Apps & Integrations | Globify"
        description="Custom Shopify apps and integrations that extend your store's functionality, from inventory management to loyalty programs and advanced analytics."
        canonical="/shopify-app-development"
        faq={[
          { question: "How much does a custom Shopify app cost?", answer: "Simple apps start at $5K–$15K. Complex apps with ERP integrations, custom APIs, and App Store listing range from $20K–$60K+." },
          { question: "Can you build private Shopify apps?", answer: "Yes. We build both public App Store apps and private apps exclusively for your store — including custom admin interfaces and automation workflows." },
          { question: "What technologies do you use for Shopify apps?", answer: "Remix/Node.js, Shopify App Bridge, Polaris UI, GraphQL Admin API, Shopify Functions, and webhooks for real-time data sync." },
          { question: "How does AEO improve Shopify app visibility?", answer: "AEO with structured data helps your Shopify app get cited by AI assistants when merchants search for e-commerce solutions, integrations, and automation tools." },
        ]}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "E-Commerce", url: "/ecommerce" },
          { name: "Shopify App Development", url: "/shopify-app-development" },
        ]}
