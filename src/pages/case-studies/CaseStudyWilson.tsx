...
const CaseStudyWilson = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Wilson Case Study — GCC Shopify E-Commerce | Globify"
        description="How Globify built a localized GCC Shopify store for Wilson Sporting Goods' regional distributor, replicating the global site with Arabic RTL and multi-country support."
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden">
              <img src={portfolioWilson} alt="Wilson Sporting Goods GCC e-commerce website" className="w-full h-[350px] object-cover rounded-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
