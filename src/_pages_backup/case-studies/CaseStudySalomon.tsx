...
const CaseStudySalomon = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Salomon Case Study — GCC Shopify E-Commerce | Globify"
        description="How Globify built a localized GCC Shopify store for Salomon's regional distributor, replicating the global outdoor brand site with Arabic RTL and multi-country support."
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-4 font-display">
                Salomon
              </h1>
              <p className="text-lg text-white/50 leading-relaxed mb-6">
                GCC distributor store for a world-leading outdoor sports brand —
                custom Shopify theme replicating Salomon's global site design
                with full Arabic RTL support, multi-language, and multi-country
                localization.
              </p>
              <div className="flex flex-wrap gap-2">
                {["Shopify", "GCC", "E-Commerce", "Performance"].map((tag) => (
                  <span
                    key={tag}
                    className="text-xs font-semibold tracking-wider uppercase px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 font-display">
                Bringing Outdoor Performance to the GCC
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Salomon's local GCC distributor needed a regional Shopify store
                that replicated the global brand's adventurous,
                performance-driven site design. The store had to support English
                and Arabic with full RTL layout, serve multiple GCC countries
                with localized currency and shipping, and showcase Salomon's
                complex product range with technical specifications.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                The challenge was maintaining Salomon's global brand identity
                and outdoor aesthetic while creating a native Arabic experience
                — ensuring product specs, sizing guides, and activity-based
                navigation felt seamless in both languages.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 font-display">
                Custom Shopify Theme for GCC Markets
              </h2>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {techStack.map((tech) => (
                <span
                  key={tech}
                  className="px-4 py-2.5 rounded-full text-sm font-medium bg-primary/5 text-foreground border border-border"
                >
                  {tech}
                </span>
              ))}
      ...
      <section className="py-20 bg-[#0a0a1a]">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-10 font-display">
              Measurable Impact
            </h2>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-foreground/80 leading-relaxed italic mb-6">
              "Globify delivered a Shopify store that captures Salomon's global
              brand spirit while being perfectly adapted for our GCC market. The
              Arabic experience and multi-country setup have been game-changers
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-white/40 max-w-lg mx-auto mb-8">
              Let's build a localized e-commerce platform for your brand.
            </p>
            <button
