...
const CaseStudyEkasys = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead title="EKASYS ERP Case Study — Enterprise Resource Planning | Globify" description="EKASYS: Modular ERP platform powering 200+ businesses with ₹800Cr+ revenue tracked. Inventory, manufacturing, finance, HR, and supply chain in one system." canonical="/case-study/ekasys-erp" />
      <Navbar />
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="rounded-2xl overflow-hidden">
              <img src={portfolioErp} alt="EKASYS ERP platform dashboard" className="w-full h-[350px] object-cover rounded-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
